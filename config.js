...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "ALI-MD~3YFRmbQQ#S4LL9VKBx6avU1sYt4ZWQjGj0K49pYsivW9dcJ2HMDw",  
//chatbot integration 
...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS JUST NOW TOHID-MD 👻*",
...
STICKER_NAME: process.env.STICKER_NAME || "TOHID-MD",    
VPS: process.env.VPS || "",
...
OWNER_NAME: process.env.OWNER_NAME || "MR IOHID",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "© POWERED BY TOHID MD⎯꯭̽💀",
// add bot desp name    
